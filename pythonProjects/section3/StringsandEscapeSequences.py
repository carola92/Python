"""
string and escape sequences: 1.create a variable and assign a string that is surrounded in double quotes to it
...
# ------------
str1 = ​"I don't know what to make of the program"
str2 = ​'still do not know'
str3 = ​"perhaps ​\"​it can be​\"​ useful"
str4 = ​"but right now ​\'​it seems to be​\'​ cumbersome"
# ----------------------------------------------------------------------------------------------------------------------
