...
# assigns pyLen the length of the string assigned to the variable py pyLen = ​len​(py)

sliceLen = ​len​(py[​1​:​4​])

num = ​1.32

# uses str() to change 1.32 to "1.32" where index 3 of "1.32" is "2" stringed = ​str​(num)[​3​]
